...
export default class News extends Component {
   ...
   async componentDidMount(){
    //    console.log('cdm')
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=c5cd6556fc3c4b7ca87b404f7f31fc5e&pageSize=${this.props.pageSize}`;
